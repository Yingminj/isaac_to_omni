...
# Define paths
id = "0020"
base_path = Path("datasets/basic1117-2/Replicator")
img_path = base_path / f"instance_segmentation/instance_segmentation_{id}.png"
semantics_path = base_path / f"instance_segmentation/instance_segmentation_semantics_mapping_{id}.json"
bbox_labels_path = base_path / f"bounding_box_2d_tight/bounding_box_2d_tight_labels_{id}.json"
output_path = Path(f"{id}_mask.png")
...
semantic_mask = np.full((height, width), 0, dtype=np.uint8)
